  ...
  return (
    <div className="flex relative min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 mb-30">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <h2 className="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">{translate("login.welcome_title")}</h2>
      </div>

      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form onSubmit={handleLogin} className="space-y-6">
          <div>
            <label htmlFor="email" className="block text-sm/6 font-medium text-gray-900">{translate("login.username")}</label>
            <div className="mt-2">
              <input
      ...
      <div>
        <p className="mt-10 text-center text-sm/6 text-gray-500">{translate("login.not_a_member")} 
          <a href="#" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> {translate("login.sign_up")} </a>
        </p>
      </div>
